namespace MightyTerrainMesh
{
    ...
    public class SamplerTree
    {
        ...
        /// 树的根节点
        /// </summary>
        private SamplerBase m_rootNode;
        ...
        {
            if (m_rootNode is SamplerNode)
            {
                SamplerNode node = (SamplerNode)m_rootNode;
        ...
        public void FillData(float angleErr)
        {
            ...
            m_rootNode.GetData(Vertices, Boundaries);
        }
        ...
        public void StitchBorder(byte flag, byte nflag, float minDis, SamplerTree neighbour)
        {
            ...
            {
                Debug.LogError("SamplerTree boundary doesn't contains corner : " + flag);
                return;
            }

            if (!neighbour.Boundaries.ContainsKey(nflag))
            {
                Debug.LogError("SamplerTree neighbour boundary doesn't contains corner : " + nflag);
                return;
            }
